        ...
        try:
            ...
            if latest_state and latest_state.network_state == "Under Attack":
                ...
                cards.append({
                    ...
                    "message": f"NVIDIA DeepSeek AI classifier and HMM state forecast confirm the network is Under Attack. Threat source: {target_agent}.",
            ...
            # RULE B: LLM Security Alerts Check (even if HMM is still transitioning)
                ...
                cards.append({
                    ...
                    "message": f"NVIDIA DeepSeek AI classified traffic anomalies on host {latest_threat.agent.hostname}.",
