...
test_model_dir = tempfile.TemporaryDirectory()
os.environ["NETINSIGHT_SVM_PATH"] = str(Path(test_model_dir.name) / "svm_model.joblib")

from netinsight.config import settings
from netinsight.classification.train import train_and_save_model, FEATURE_COLUMNS
