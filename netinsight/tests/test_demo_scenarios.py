...
class TestDemoScenarios(TestCase):
    ...
    def test_scenario_2_mobile_hotspot_scaling(self):
        """Verifies Scenario 2 triggers 8.5 Mbps capacity scaling."""
    ...
    def test_scenario_3_ddos_incident_response(self):
        """Verifies Scenario 3 triggers DDoS volumetric attack response."""
    ...
    def test_api_trigger_scenario_endpoint(self):
        ...
        res = self.client.post(url, {"scenario_id": 3}, content_type="application/json")
